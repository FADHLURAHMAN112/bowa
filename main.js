...
console.log(color('> GITHUB: FADHLURAHMAN112 ','silver'))
console.log(color('> WA Gue: +6289604092736 ','silver'))
console.log(color('  Bot Wangsaff','mediumseagreen'))
    ...
    console.log(color('<>','red'), color('Bug lapor dek', 'aqua'), color('https://wa.me/6289604092736'))
	...
	marubotz.browserDescription = [ 'FDLMODZZ', 'chrome', '3.0' ]
    marubotz.on('qr', () => {
